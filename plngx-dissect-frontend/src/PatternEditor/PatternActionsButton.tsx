                ...
                <Paper>
                    <ClickAwayListener onClickAway={onPopupClose}>
                        <ButtonGroup orientation="vertical" variant="contained">
                            ...
                            <ConfirmButton style={{ borderColor: '#666' }} variant="outlined" icon={<Sync/>} disabled={isSaving || isModified || pattern === null || document === null || pattern.enabled === false}  dialogTitle="Process Document?" dialogText="Process the current document with this pattern?" color="warning" onConfirmed={onProcessDocumentConfirmed}>Process</ConfirmButton>
